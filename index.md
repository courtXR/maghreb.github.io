...
<body>
    <div class="wrapper">
        <header class="main-nav">
            <div class="logo">
                <img src="images/logo_web_wht.gif">
                <span>Courtney Taylor</span>
            </div>
            <div class="social-links">
                <ul>
                    <li><a href="https://www.linkedin.com/in/courtneytaylorxr/">
                        <!--linkedin-->
                    ...
                    <li><a href="https://www.behance.net/courtneyjt9cc5">
                        <!--behance-->
                    ...
                    <li><a href="https://www.instagram.com/courtneytaylortvs/">
                       <!--instagram-->
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <li><a href="https://github.com/maghreb">
                        <!--github-->
                        <svg id="Bold" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav class="nav-list">
                <ul>
                    ...
                    <li><a href="https://www.dropbox.com/s/vk8tynm1gwza005/Resume%20Courtney%20Taylor.pdf?dl=0">Resume</a></li>
        ...
        <section class="projects-wrapper">
            ...
            <div class="project">
                ...
                <div class="project-info-wrapper">
                    <h1 class="project-title">Prima Materia</h1>
                    <div class="project-details">
                        <div class="client">
                            <h4>Client</h4>
                            The Nook Gallery
